                ...
                <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
                    ...
                    >
                        ...
                        <div
                            ...
                            style={{ backgroundColor: localProfile.bannerColor }}
                        />
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <div className="flex gap-2 mt-2 justify-center flex-wrap">
                                        {colors.map(color => (
                                            <button
                                                key={color}
                                                onClick={() => setLocalProfile(prev => ({ ...prev, bannerColor: color }))}
                                                className={`w-8 h-8 rounded-full border-2 transition-transform hover:scale-110 ${localProfile.bannerColor === color ? 'border-white scale-110' : 'border-transparent'}`}
                                ...
                                <div className="flex gap-3 mt-6">
                                    <button
                                        ...
                                        className="flex-1 py-3 rounded-xl bg-red-500/10 hover:bg-red-500/20 text-red-500 font-semibold transition-all active:scale-[0.98] flex items-center justify-center gap-2 border border-red-500/20"
                                    >
                                    ...
                                    <button
                                        onClick={handleSave}
                                        className="flex-[2] py-3 rounded-xl bg-primary text-primary-foreground font-bold hover:brightness-110 transition-all active:scale-[0.98] flex items-center justify-center gap-2"
                                    >
